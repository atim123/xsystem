...
public class CorrelationKeyImpl extends BaseElementImpl implements CorrelationKey {
    ...
    String name;
    List<Reference<CorrelationProperty>> correlationProperty = new ArrayList();

    public CorrelationKeyImpl(DefinitionsImpl definitions) {
        super(definitions);
    }
    ...
    @Override
    public List<Reference<CorrelationProperty>> getCorrelationProperty() {
