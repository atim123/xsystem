 ...
 */
public class IntermediateThrowEventComposer extends ThrowEventComposer{

    @Override
    public Element composer(Element root, Object src) {
        IntermediateThrowEvent intermediateThrowEvent = (IntermediateThrowEvent) src;
        Element ret = makeBaseElement(root, "intermediateThrowEvent", intermediateThrowEvent);
