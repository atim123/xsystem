 ...
 */
public class IntermediateCatchEventComposer extends CatchEventComposer{
    
    @Override
    public Element composer(Element root, Object src) {
        IntermediateCatchEvent intermediateCatchEvent = (IntermediateCatchEvent) src;
        Element ret = makeBaseElement(root, "intermediateCatchEvent", intermediateCatchEvent);
