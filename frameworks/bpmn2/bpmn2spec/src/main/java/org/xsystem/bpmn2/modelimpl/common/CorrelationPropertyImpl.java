...
public class CorrelationPropertyImpl extends RootElementImpl implements CorrelationProperty{
    String name;
    String type;
    List<CorrelationPropertyRetrievalExpression> correlationPropertyRetrievalExpressions=new ArrayList();
    ...
    public CorrelationPropertyImpl(DefinitionsImpl definitions){
        super(definitions);
    }
    @Override
    ...
    public List<CorrelationPropertyRetrievalExpression> getCorrelationPropertyRetrievalExpressions() {
        return correlationPropertyRetrievalExpressions;
    }
}
