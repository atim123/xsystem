 ...
 */
public class StartEventExecution extends Execution{

    public StartEventExecution(ExecutionService owner) {
        super(owner);
    }
    ...
    public void execute(Token token) {
        ...
        StartEvent  startEvent =(StartEvent) ref.resolvedReference();
         
        List<Reference<FlowNode>> outgoing = startEvent.getOutgoingNode();
